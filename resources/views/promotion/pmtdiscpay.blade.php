...
@section('content')
 ...
 <div class="col-md-12">
     <h3><i class="fa fa-list"></i>บันทึกข้อมูลส่วนลด การชำระเงิน</h3> 
            <div class="panel-group accordion-custom accordion-teal">
                ...
                <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="container">
                                <fieldset>
                                    <form class="form-horizontal" role="form" method="GET" action="{{url('search-pmtdiscpay')}}">
                                        <div   class="row">
 ...
 <!--        <legend></legend> -->
            ...
            <div id="ajaxTable" class="table-responsive top10">
                @include('promotion.pmtdiscpay_lv') 
            </div> 
...
@include('modals.modal-crud-productset')
    ...
    <div class="modal fade transmst_modal" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="transmst_modal">
