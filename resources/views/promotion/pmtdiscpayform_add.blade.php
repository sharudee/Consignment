...
<div class="col-sm-2">
	...
	@endforeach	
				<div class="row form-group">
					...
					<div class="col-sm-1">
						<a href="#" rel="click_trnsaction" class="btn btn-sm btn-info">
	...
	<button type="button"  id="click_add_pmtdiscpay" name="click_add_pmtdiscpay"  class="btn btn-primary">เพิ่มรายการ</button>
	<input type="hidden" name="_token" value="{{csrf_token()}}">
...
<div class="modal-footer">
	<button type="button"  id="submitpmtdiscpay" class="btn btn-primary"><i class="fa fa-save"></i>บันทึก</button>
