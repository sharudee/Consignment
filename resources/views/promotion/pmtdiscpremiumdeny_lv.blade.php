	...
	<tbody>
		...
		<tr>
			...
			<td class="col-xs-1 col-sm-1 col-md-1">
				...
				data-href="{{URL::to('getpmtdiscpremiumdenyform/'.$v->pmt_mast_id)}}" data-modal-title="ส่วนลดไม่รับของแถม (เลขที่โปรโมชั่น::{{$v->pmt_no}})" >
				<i class="fa fa-pencil"></i>ส่วนลด</button>
			</td>
		</tr>
		@endforeach
	</tbody>
