...
<div class="modal-body">
	...
	<input type="hidden"  id= "Su_System_Id" type="hidden" name="Su_System_Id" value="{{$v->Su_System_Id}}"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
	            <input type="text" name="txt_SystemNameThai" id="txt_SystemNameThai"  value="{{$v->SystemNameThai}}" required="required" class="form-control" data-message="กรุณาระบุ ชื่อโปรโมชั่น" readonly>		
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">ชื่อระบบ(Eng)</label>
					<div class="col-md-7">
						 <input type="text" class="form-control" name="txt_SystemNameEng" id="txt_SystemNameEng" value="{{$v->SystemNameEng}}" readonly>
					</div>
					<label class="col-sm-1 control-label">ลำดับ</label>
					<div class="col-md-2">
						 <input type="text" class="form-control" name="txt_SystemSeq" id="txt_SystemSeq" value="{{$v->SystemSeq}}" readonly>
					</div>
...
<div class="modal-footer">
	<button type="button"  id="SaveDeleteSystem" class="btn btn-primary"><i class="fa fa-save"></i>บันทึก</button>
