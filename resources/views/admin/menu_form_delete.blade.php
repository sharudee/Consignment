    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Level</label>
                    <div class="col-md-3">
                         <input type="text" class="form-control" name="MenuLevel" id="MenuLevel" value="{{$v->MenuLevel}}" readonly >
                    </div>
                    <label class="col-sm-1 control-label">ชื่อเมนู</label>
                    <div class="col-md-6">
                         <input type="text" class="form-control" name="MenuName" id="MenuName" value="{{$v->MenuName}}" readonly>
                    </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">ชื่อ Icon class</label>
            <div class="col-sm-10">
                <input type="text" name="icon_class_name" id="icon_class_name" value="{{$v->icon_class_name}}" required="required" class="form-control" data-message="กรุณาระบุ ชื่อโปรโมชั่น" readonly>      
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">ลำดับ</label>
                    <div class="col-md-2">
                         <input type="text" class="form-control" name="MenuSeq" id="MenuSeq" value="{{$v->MenuSeq}}"readonly>
                    </div>
...
<div class="modal-footer">
    <button type="button"  id="SaveDeleteMenu" class="btn btn-primary"><i class="fa fa-save"></i>บันทึก</button>
