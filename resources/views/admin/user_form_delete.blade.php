    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">ชื่อผู้ใช้งาน</label>
                    <div class="col-md-10">
                         <input type="text" class="form-control required" name="fullname" id="fullname" value="{{$v->fullname}}" readonly>
                    </div>
        ...
        <div class="form-group">
            ...
            <label class="col-sm-1 control-label">Tel :</label>
                    <div class="col-md-5">
                         <input type="text" class="form-control required" name="tel" id="tel" value="{{$v->tel}}" readonly >
                    </div>
        </div>
        <div class="form-group">
...
<div class="modal-footer">
    <button type="button"  id="SaveDeleteUser" class="btn btn-primary"><i class="fa fa-save"></i>ลบข้อมูล</button>
