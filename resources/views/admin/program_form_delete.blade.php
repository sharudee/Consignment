...
<div class="modal-body">
	...
	<input type="hidden"  id= "Su_ProgramList_Id" type="hidden" name="Su_ProgramList_Id" value="{{$v->Su_ProgramList_Id}}"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
	            <input type="text" name="ProgramDescription" id="ProgramDescription"  value="{{$v->ProgramDescription}}" required="required" class="form-control" data-message="กรุณาระบุ ชื่อโปรโมชั่น" readonly>		
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">Route Url</label>
					<div class="col-md-7">
						 <input type="text" class="form-control" name="RouteUrl" id="RouteUrl" value="{{$v->RouteUrl}}" readonly>
					</div>
					<label class="col-sm-1 control-label">ลำดับ</label>
					<div class="col-md-2">
						 <input type="text" class="form-control" name="SortSeq" id="SortSeq" value="{{$v->SortSeq}}" readonly>
					</div>
...
<div class="modal-footer">
	<button type="button"  id="SaveDeleteProgram" class="btn btn-primary"><i class="fa fa-save"></i>บันทึก</button>
