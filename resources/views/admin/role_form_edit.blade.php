...
<div class="modal-body">
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
	            <input type="text" name="RoleDescription" id="RoleDescription" value="{{$v->RoleDescription}}"  required="required" class="form-control" data-message="กรุณาระบุ ชื่อโปรโมชั่น" >		
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">ประเภทสิทธิ์</label>
			<div class="col-sm-10">
	            <input type="text" name="PermissionsType" id="PermissionsType" value="{{$v->PermissionsType}}" required="required" class="form-control" data-message="กรุณาระบุ ชื่อโปรโมชั่น" >		
			</div>
		</div>
...
<div class="modal-footer">
	<button type="button"  id="SaveEditRole" class="btn btn-primary"><i class="fa fa-save"></i>บันทึก</button>
