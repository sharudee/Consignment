...
@section('content')
 ...
 <div class="col-md-12">
     <h3><i class="fa fa-list"></i>กำหนดหมวดระบบ</h3> 
            <div class="panel-group accordion-custom accordion-teal">
                ...
                <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="container">
                                <fieldset>
                                    <form class="form-horizontal" role="form" method="GET" action="{{url('search-system')}}">
                                        <div   class="row">
                                            <div   class="form-group">
                                                <div class="col-xs-12 col-sm-2 col-md-2">
                                                    <label class="control-label">รหัส/ชื่อระบบ</label>
                                                </div>
            ...
            <a href="#" rel="newsystem" class="btn btn-md btn-primary"><i class="fa fa-plus-square-o"></i>เพิ่มข้อมูล</a>
            <legend></legend>

            <div id="ajaxTable" class="table-responsive top10">
                @include('admin.system_lv') 
            </div> 
