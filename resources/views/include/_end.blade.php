...
<script src="<?php echo URL::to('resources/assets/js/moment.js');?>"></script>
...
<!-- DATA TABLES -->
<script type='text/javascript' src="<?php echo URL::to('resources/assets/vendor/datatables/datatables.min.js');?>"></script>  
<script type='text/javascript' src="<?php echo URL::to('resources/assets/vendor/datatables/datatables-bootstrap.js');?>"></script>    
<!-- END DATA TABLES -->	
...
<script src="<?php echo URL::to('resources/assets/js/custom_report.js');?>"></script>
...
<script src="<?php echo URL::to('resources/assets/js/custom_promotion_consignnee.js');?>"></script> 
<script src="<?php echo URL::to('resources/assets/js/custom_promotion_discount.js');?>"></script> 
<script src="<?php echo URL::to('resources/assets/js/custom_promotion_product.js');?>"></script> 

<script src="<?php echo URL::to('resources/assets/js/custom_productset.js');?>"></script>

<script src="<?php echo URL::to('resources/assets/js/custom_pmtgrpmast.js');?>"></script> 
<script src="<?php echo URL::to('resources/assets/js/custom_pmttransmast.js');?>"></script>  
<script src="<?php echo URL::to('resources/assets/js/custom_promotion_package.js');?>"></script>  
<script src="<?php echo URL::to('resources/assets/js/custom_pmtdiscpremiumdeny.js');?>"></script> 
