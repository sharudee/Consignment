...
@section('content')
	...
	<div class="col-md-12">
		...
		<div class="col-md-2 ">
			<!--<button type="button" class="btn btn-primary solsoShowModal"  data-toggle="modal" data-target="#solsoCrudModal" data-href="{{URL::to('printtime/'. $emp_code ) }}" data-modal-title="Print">
		<i class="fa fa-print"></i> พิมพ์เวลาทำงาน</button>-->
		</div>
		<div class="col-md-12 ">
			<!--<h3>ตารางการทำงาน : {{$emp_code . ' - '. $name }}</h3>-->
			<div id="ajaxTable" class="table-responsive">
				@include('commission.pcwork_table')
			</div> 
		</div>
