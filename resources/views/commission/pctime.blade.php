	...
	<form class="form-horizontal" role="form">
			...
			<div class="form-group">
				<div class="col-sm-10 col-sm-offset-2">
					<button type="button" class="btn btn-danger" id="SubmitIn"><i class="fa fa-sign-in"></i>In</button>
					<button type="button" class="btn btn-primary" id="SubmitOut"><i class="fa fa-sign-out"></i>Out</button>
				</div>
			</div>
	</form>
</div>
