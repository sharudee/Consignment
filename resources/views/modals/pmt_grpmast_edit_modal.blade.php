...
{!! Form::open(array('url' => 'submiteditpmtgrpmastform/' . Request::segment(2) , 'role' => 'form', 'method' => 'POST', 'class' => 'solsoForm')) !!} 
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">แก้ไข กลุ่มข้อมูล</h4>
			</div>
			<div class="modal-body">
				<div class="row solsoShowForm"></div>
			</div>
			<div class="modal-footer">
				<button type="submit" id="save_edit_pmtgrpmast" class="btn btn-primary"><i class="fa fa-save"></i>บันทึก</button>
